...
//        productPriceEntity.setIdPrice(101);
...
//            savedOrder.setIdOrder(1000); // Simula ID generado
//            return savedOrder;
//        });
//
//        // Datos de prueba
...
//        assertDoesNotThrow(() -> {
//            Integer orderId = orderService.createOrder(request).getIdOrder();
