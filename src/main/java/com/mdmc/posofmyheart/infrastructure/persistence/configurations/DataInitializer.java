...
public class DataInitializer implements ApplicationRunner {
    ...
    private void initializeProducts() {
        ...
        List<ProductEntity> products = Arrays.asList(
                new ProductEntity(1L, esquitesCategory, "Doriesquites", "Doritos con esquites",
                        "https://drive.google.com/thumbnail?id=1GmaqB_ifP0h-Ck6S_ENZi45PfH7tbwEq", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(2L, esquitesCategory, "Tostiesquites", "Tostiesquites con esquites",
                        "https://drive.google.com/thumbnail?id=1v2OT5_GYNYSsr7XaHqnsxEEax1jLtWit", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(3L, esquitesCategory, "Esquites Tradicionales", "Esquites con mayonesa, queso y picante",
                        "https://drive.google.com/thumbnail?id=1ph3Iog_GrUF6VY2DmiapwquOCUcTDTNx", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(4L, esquitesCategory, "Esquites con Queso Manchego/Amarillo", "Esquites tradicionales con queso extra",
                        "https://drive.google.com/thumbnail?id=1ZG_sIFvIvUyBNK0x1as1WvDNAC2RIP10", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(5L, esquitesCategory, "Esquite Maruchan", "Sopa maruchan con esquites",
                        "https://drive.google.com/thumbnail?id=1xOzM-Yl3VVgGufYwaxmIpDHQ94yEzEIY", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(6L, esquitesCategory, "Maíz Puerco", "Maruchan con esquites y carne de puerco",
                        "https://drive.google.com/thumbnail?id=1_DwAv9akn8dmrq-sO_PAAaAEEGPwPIF_", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(7L, esquitesCategory, "Maíz Puerco sin sopa", "Esquites con carne de puerco sin maruchan",
                        "https://drive.google.com/thumbnail?id=1_DwAv9akn8dmrq-sO_PAAaAEEGPwPIF_", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(8L, elotesCategory, "Elote Tradicional", "Elote con mayonesa, queso y picante",
                        "https://drive.google.com/thumbnail?id=1R0z_q1JH1H7mlpSvbUt36pGbfGuUPmJk", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(9L, elotesCategory, "Elote Revolcado", "Elote con topping a elegir",
                        "https://drive.google.com/thumbnail?id=1i1r2iQQIfm0TsfbCJxxlEGahcmT5TwWc", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(10L, bebidasCategory, "Red Cola 600ml", "Refresco en botella PET",
                        "https://drive.google.com/thumbnail?id=1bDM3IJmOQDtl1xz1OquqH4UFiKU90J5d", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(11L, bebidasCategory, "Coca Cola", "Refresco en botella PET o lata",
                        "https://drive.google.com/thumbnail?id=1C41w2JUpvJleSgnrUiLR5s4jXek0bMUM", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(12L, bebidasCategory, "Boing 500ml", "Jugo en caja 500ml",
                        "https://drive.google.com/thumbnail?id=1PUk_tLBQoctGdNcG1MsbrGHEE6SONwTd", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(13L, bebidasCategory, "Jumex Lata", "Jugo en lata 355ml",
                        "https://drive.google.com/thumbnail?id=1UlTILnkyeo25amhkSwTfDGAa4tteEGeg", LocalDateTime.now(), LocalDateTime.now(), List.of()),
                new ProductEntity(14L, bebidasCategory, "Agua de frutos", "Vaso de agua natural",
                        "https://drive.google.com/thumbnail?id=1c8g7ud-wX-As_8f5Mxz2m7xv1XjFUXuv", LocalDateTime.now(), LocalDateTime.now(), List.of())
        );
